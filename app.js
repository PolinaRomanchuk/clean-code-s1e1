...
var incompleteTaskHolder=document.querySelector(".task-list__items_incomplete");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".task-list__items_completed");//completed-tasks
